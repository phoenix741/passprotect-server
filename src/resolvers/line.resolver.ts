...
export class LineResolver {
  ...
  @ResolveProperty('user', returns => UserDto, { description: 'Owner of the list' })
  ...
  @Query(type => [WalletLine], { description: 'Request the list of lines from the connected users.' })
  ...
  @Mutation(returns => UpdateLineResultUnion, { description: 'Create or Update a WalletLine' })
