...
@ObjectType({
  description: 'Wallet transaction, used to synchronize lines between devices',
})
export class WalletTransaction {
  ...
  @Field(type => TransactionTypeEnum, {
    description: 'Type of the object modified (only line)',
  })
  type: TransactionTypeEnum;

  @Field(type => WalletLine, {
    description: 'The line before the modification',
    nullable: true,
  })
  before?: WalletLine;

  @Field(type => WalletLine, {
    description: 'The line after the modification',
    nullable: true,
  })
  after?: WalletLine;
